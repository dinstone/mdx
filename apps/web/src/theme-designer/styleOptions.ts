...
export const strongStyleOptions: StylePresetOption[] = [
  { id: "none", label: "基础加粗" },
  { id: "color", label: "随主题色" },
...
export const inlineCodeStyleOptions: StylePresetOption[] = [
  { id: "simple", label: "基础" },
  { id: "rounded", label: "圆角" },
...
export const codeBlockThemeOptions: StylePresetOption[] = [
...
export const underlineStyleOptions: StyleOption[] = [
...
export const borderStyleOptions: StyleOption[] = [
  { label: "实线", value: "solid" },
  { label: "虚线", value: "dashed" },
  { label: "点线", value: "dotted" },
...
export const hrStyleOptions: StyleOption[] = [
  { label: "实线", value: "solid" },
  { label: "虚线", value: "dashed" },
  { label: "点线", value: "dotted" },
  { label: "双线", value: "double" },
